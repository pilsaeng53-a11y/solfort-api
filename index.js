...
app.get('/', (req,res) => res.json({name:'SolFort API Server v1.0',status:'running',endpoints:['/health','/api/auth/login','/api/auth/register','/api/users','/api/sales','/api/leads','/api/notices','/api/attendance','/api/journals','/api/incentives','/api/audit','/api/reviews','/api/settlements','/api/scripts','/api/init-admin']}));
